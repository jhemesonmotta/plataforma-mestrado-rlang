...
```{r}
xp_valores <- c(1.9,1.9,5.7,13.2,17,28.3,32.1)

xp_labels <- c("Até 5 anos", "Entre 8 e 10 anos", "Entre 10 e 15 anos", "Até 1 ano", "Entre 5 e 7 anos", "Mais de 15 anos", "Entre 2 e 4 anos")
